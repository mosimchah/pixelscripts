...
su
    ...
    echo "4500" > /sys/devices/system/cpu/cpu4/cpufreq/sched_pixel/up_rate_limit_us
    ...
    echo "1836000" > /sys/devices/system/cpu/cpu4/cpufreq/sched_pixel/limit_frequency
    echo "4500" > /sys/devices/system/cpu/cpu6/cpufreq/sched_pixel/up_rate_limit_us
    ...
    echo "2252000" > /sys/devices/system/cpu/cpu6/cpufreq/sched_pixel/limit_frequency
