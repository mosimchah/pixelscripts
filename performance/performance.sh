...
su
    ...
    echo "1803000" > /sys/devices/system/cpu/cpufreq/policy0/scaling_max_freq
    echo "2253000" > /sys/devices/system/cpu/cpufreq/policy4/scaling_max_freq
    echo "2802000" > /sys/devices/system/cpu/cpufreq/policy6/scaling_max_freq
