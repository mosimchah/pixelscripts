#!/system/bin/sh
su
    echo "29000" > /sys/devices/system/cpu/cpu0/cpufreq/sched_pixel/up_rate_limit_us
    ...
    echo "29000" > /sys/devices/system/cpu/cpu4/cpufreq/sched_pixel/up_rate_limit_us
    ...
    echo "1491000" > /sys/devices/system/cpu/cpu4/cpufreq/sched_pixel/limit_frequency
    echo "29000" > /sys/devices/system/cpu/cpu6/cpufreq/sched_pixel/up_rate_limit_us
    ...
    echo "1826000" > /sys/devices/system/cpu/cpu6/cpufreq/sched_pixel/limit_frequency
    ...
    echo "1826000" > /sys/devices/system/cpu/cpufreq/policy6/scaling_max_freq
